...
tree = uproot.open("./data/posterior_LH2_messy_MC_pT_0.root:tree")
theta = tree["theta"].array().to_numpy()
posterior = tree["posterior"].array().to_numpy()
...
tree = uproot.open("./data/posterior_LH2_messy_MC_pT_0.root:tree")
theta = tree["theta"].array().to_numpy()
meas = tree["mean"].array().to_numpy()
error = tree["std"].array().to_numpy()
