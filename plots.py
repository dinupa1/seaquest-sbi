...
input_file = "./data/eval_pT_bin_0.root"
...
for i in range(5):
    ...
    plt.tight_layout()
    plt.savefig(f"./plots/lambda_{i}_pT_bin_0.png")
    plt.close("all")
    ...
    plt.legend(frameon=False)
    plt.tight_layout()
    plt.savefig(f"./plots/mu_{i}_pT_bin_0.png")
    plt.close("all")
    ...
    plt.legend(frameon=False)
    plt.tight_layout()
    plt.savefig(f"./plots/nu_{i}_pT_bin_0.png")
    plt.close("all")
...
plt.legend(frameon=False)
plt.tight_layout()
plt.savefig("./plots/lambda_pT_bin_0.png")
plt.close("all")
...
plt.legend(frameon=False)
plt.tight_layout()
plt.savefig("./plots/mu_pT_bin_0.png")
plt.close("all")
...
plt.legend(frameon=False)
plt.tight_layout()
plt.savefig("./plots/nu_pT_bin_0.png")
plt.close("all")
...
plt.legend(frameon=False)
plt.tight_layout()
plt.savefig("./plots/lambda_score_pT_bin_0.png")
plt.close("all")
...
plt.legend(frameon=False)
plt.tight_layout()
plt.savefig("./plots/mu_score_pT_bin_0.png")
plt.close("all")
...
plt.legend(frameon=False)
plt.tight_layout()
plt.savefig("./plots/nu_score_pT_bin_0.png")
plt.close("all")
...
plt.legend(frameon=False)
plt.tight_layout()
plt.savefig("./plots/lambda_true_score_pT_bin_0.png")
plt.close("all")
...
plt.legend(frameon=False)
plt.tight_layout()
plt.savefig("./plots/mu_true_score_pT_bin_0.png")
plt.close("all")
...
plt.legend(frameon=False)
plt.tight_layout()
plt.savefig("./plots/nu_true_score_pT_bin_0.png")
plt.close("all")
...
plt.tight_layout()
plt.savefig("./plots/lambda_true_error_pT_bin_0.png")
plt.close("all")
...
plt.tight_layout()
plt.savefig("./plots/mu_true_error_pT_bin_0.png")
plt.close("all")
...
plt.ylabel(r"$\sigma_{\nu}$")
plt.tight_layout()
plt.savefig("./plots/nu_true_error_pT_bin_0.png")
plt.close("all")
