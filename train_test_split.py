...
val_dic_D = {
    ...
    "true_pT": data_val_D["pT"],
    "true_xF": data_val_D["xF"],
    "phi": data_val_D["phi"],
...
test_dic_D = {
    ...
    "true_pT": data_test_D["pT"],
    "true_xF": data_test_D["xF"],
    "phi": data_test_D["phi"],
    "costh": data_test_D["costh"],
}

fit_dic_D = {
    "true_mass": data_fit_D["true_mass"],
    "true_pT": data_fit_D["true_pT"],
    "true_xF": data_fit_D["true_xF"],
    "phi": data_fit_D["phi"],
