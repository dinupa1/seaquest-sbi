...
data_size = np.array([1000, 3000, 5000, 10000, 15000])
...
for N_data in data_size:

    # generate events
    generator()

    # forward simulation
    forward_simulation(0, num_events, N_data)
...
outfile = uproot.recreate("./data/hyperparameter2.root", compression=uproot.ZLIB(4))
outfile["tree"] = tree
outfile.close()
